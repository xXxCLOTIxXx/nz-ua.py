<body>
	<p align="center">
	    ...
	    <a href="https://github.com/xXxCLOTIxXx/nz-ua.py/blob/main/docs/main.md"><img src="https://img.shields.io/website?down_message=failing&label=docs&up_color=green&up_message=passing&url=https://github.com/xXxCLOTIxXx/nz-ua.py/blob/dev/docs/main.md" alt="docs" /></a>
	</p>
	<table align="center">
		</tr>
